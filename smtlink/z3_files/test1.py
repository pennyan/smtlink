...
conclusion=s.lt((lambda var0,var1:s.times(var0,s.plus(1,var1)))(X,(lambda var2,var3:s.times(var2,s.plus(1,var3)))(X,Z)),(lambda var4,var5:s.times(var4,s.plus(1,var5)))(X,Y))
