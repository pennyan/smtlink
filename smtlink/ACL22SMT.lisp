...
(defun ACL22SMT () 
  (list
    (list "from" #\Space "z3" #\Space "import" #\Space "Solver" #\, #\Space "Bool" #\, #\Space "Int" #\, #\Space "Real" #\, #\Space "BoolSort" #\, #\Space "IntSort" #\, #\Space "RealSort" #\, #\Space "And" #\, #\Space "Or" #\, #\Space "Not" #\, #\Space "Implies" #\, #\Space "sat" #\, #\Space "unsat" #\, #\Space "Array" #\, #\Space "Select" #\, #\Space "Store" #\, #\Space "ToInt"  #\Newline )
    (list  #\Newline )
    ...
    (list  #\Newline )
    (list "class" #\Space "to_smt" #\( "object" #\) #\:  #\Newline )
    ...
    (list  #\Newline )
    (list #\Space #\Space #\Space #\Space #\# #\Space "special" #\Space "care" #\Space "for" #\Space "reciprocal" #\Space "because"  #\Newline )
    (list #\Space #\Space #\Space #\Space #\# #\Space "in" #\Space "ACL2" #\Space "3" "/" "0" #\Space "=" #\Space "0" #\Space "and" #\Space "in" #\Space "z3" #\Space "3" "/" "0" #\Space "=" "=" #\Space "0"  #\Newline )
    (list #\Space #\Space #\Space #\Space #\# #\Space "will" #\Space "return" #\Space "a" #\Space "counter" "-" "example"  #\Newline )
    ...
    (list #\Space #\Space #\Space #\Space #\Space #\Space #\Space #\Space "elif" #\( "x" #\. "sort" #\( #\) #\Space "=" "=" #\Space "IntSort" #\( #\) #\) #\: #\Space "return" #\Space "1" "/" #\( "Q" #\( "1" #\, "1" #\) "*" "x" #\)  #\Newline )
