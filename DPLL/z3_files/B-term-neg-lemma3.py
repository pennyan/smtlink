...
V0=s.isReal("V0")
G1=s.isReal("G1")
hypothesis=s.ifx(s.equal(EXPT_GAMMA_MINUS_H,s.reciprocal(EXPT_GAMMA_H)),s.ifx(s.lt(1,EXPT_GAMMA_H),s.ifx(s.notx(s.lt(H,1)),s.ifx(s.notx(s.lt(V0,Q(9,10))),s.ifx(s.notx(s.lt(Q(11,10),V0)),s.equal(G1,Q(1,3200)),False),False),False),False),False)
