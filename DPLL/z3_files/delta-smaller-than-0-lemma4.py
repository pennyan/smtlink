...
V0=s.isReal("V0")
DV=s.isReal("DV")
hypothesis=s.ifx(s.equal(EXPT_GAMMA_2,Q(1,25)),s.ifx(s.equal(EXPT_GAMMA_1,Q(1,5)),s.ifx(s.notx(s.lt(N,3)),s.ifx(s.notx(s.lt(640,N)),s.ifx(s.equal(G1,Q(1,3200)),s.ifx(s.notx(s.lt(V0,Q(9,10))),s.ifx(s.notx(s.lt(Q(11,10),V0)),s.equal(DV,0),False),False),False),False),False),False),False)
