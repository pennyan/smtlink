...
DV=s.isReal("DV")
PHI0=s.isReal("PHI0")
hypothesis=s.ifx(s.notx(s.lt(PHI0,s.plus(-1,s.plus(s.reciprocal(s.plus(Q(3199,3200),V0)),s.plus(s.times(DV,s.reciprocal(s.plus(Q(3199,3200),V0))),s.times(V0,s.reciprocal(s.plus(Q(3199,3200),V0)))))))),s.ifx(s.notx(s.lt(s.times(Q(10,9),V0),1)),s.ifx(s.notx(s.lt(Q(11,10),V0)),s.ifx(s.notx(s.lt(1,s.negate(s.times(8000,DV)))),s.ifx(s.notx(s.lt(1,s.times(8000,DV))),s.ifx(s.notx(s.lt(PHI0,0)),s.lt(PHI0,s.plus(-1,s.plus(s.reciprocal(s.plus(Q(1599,1600),V0)),s.plus(s.times(DV,s.reciprocal(s.plus(Q(1599,1600),V0))),s.times(V0,s.reciprocal(s.plus(Q(1599,1600),V0))))))),False),False),False),False),False),False)
